...
public class runred : MonoBehaviour
{
    ...
    public void TriggerWin3()
    {
        StartCoroutine(WinGame3()); // this is to Start the WinGame coroutine
    }

    private IEnumerator WinGame3()
    {
    ...
    public void TriggerLose3()
    {
        StartCoroutine(LoseGame3()); // Start the LoseGame coroutine
    }

    private IEnumerator LoseGame3()
    {
